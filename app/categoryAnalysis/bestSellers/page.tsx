          ...
          <div className="text-[#16252D80] w-1/2 space-y-4 shadow-md shadow-gray-300 bg-white p-4 rounded-2xl">
            ...
            <div className="ml-4">
              <ul className="list-disc ">
                <li>
                  Marketplaces have not categorized shoes into further
                  categories on the basis of categories. Therefore the keywords
                  were identified from title for:
                ...
                <li>
                  There were some other categories in which products are
                  available like Jordans & Sneakers. Rest of the products were
                  added in the miscellaneous categories.
                </li>
